...
const SHEJI_TRANSLATIONS = {
  en: {
    ...
    cart: {
      ...
      checkoutEyebrow: "checkout details",
      checkoutTitle: "Delivery and payment",
      checkoutHint: "Leave contact details and card info to finish the order.",
  ...
  ru: {
    ...
    nav: {
      ...
      backToCollection: "Вернуться к коллекции",
    ...
    cart: {
      ...
      popoverLine: "{name} x {quantity}",
      itemMeta: "{colour} / {sizes}",
      itemsAria: "Товары в корзине",
      checkoutEyebrow: "данные заказа",
      checkoutTitle: "Доставка и оплата",
      checkoutHint: "Оставьте контакты и данные карты, чтобы завершить заказ.",
