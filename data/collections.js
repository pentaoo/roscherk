...
window.SHEJI_COLLECTIONS = [
  ...
  },
  {
    ...
    look: [
      {
        productId: "stone-bucket-1",
        desktop: { x: 48, y: 17, w: 31, z: 5, rotate: 1 },
        mobile: { x: 50, y: 13, w: 43, z: 5, rotate: 1, from: "right" },
        parallax: 46,
      },
      {
        productId: "stone-overshirt-1",
        desktop: { x: 48, y: 38, w: 42, z: 3, rotate: -1 },
        mobile: { x: 50, y: 39, w: 60, z: 3, rotate: -1, from: "left" },
        parallax: 28,
      },
      {
        productId: "stone-painter-pants-1",
        desktop: { x: 47, y: 72, w: 32, z: 1, rotate: -2 },
        mobile: { x: 48, y: 70, w: 43, z: 1, rotate: -2, from: "right" },
        parallax: 18,
      },
      {
        productId: "stone-frame-bag-1",
        desktop: { x: 66, y: 58, w: 31, z: 4, rotate: 7 },
        mobile: { x: 68, y: 58, w: 42, z: 4, rotate: 7, from: "left" },
        parallax: 54,
      },
      {
        productId: "stone-braided-belt-1",
        desktop: { x: 48, y: 51, w: 28, z: 6, rotate: 3 },
        mobile: { x: 50, y: 51, w: 38, z: 6, rotate: 3, from: "right" },
        parallax: 34,
      },
    ],
  },
